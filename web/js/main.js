...
//удаление из корзины отдельных позиций
$('#modal-cart .modal-body').on('click', '.del-item', function (){      //'del-item' - делегирование, т.к. элементы появляются асинхронно
    let id = $(this).data('id');
    $.ajax({
        url: 'cart/del-item',
        data: {id: id},
