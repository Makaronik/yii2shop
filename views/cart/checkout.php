...
<div class="products-breadcrumb">
    <div class="container">
        <ul>
            <li><i class="fa fa-home" aria-hidden="true"></i><a href="<?php use yii\helpers\Html;

                \yii\helpers\Url::home() ?>">Home</a><span>|</span></li>
                            ...
                            <?php $i = 1; foreach ($session['cart'] as $id => $item): ?>
                                <tr>
                                    ...
                                    <td class="invert-image"><a
                                                href="<?= \yii\helpers\Url::to(['category/view', 'id' => $id]) ?>"><?= Html::img("@web/product/{$item['img']}", ['alt' => $item['title'], 'class' => 'img-responsive']) ?></a>
                                    </td>
                                    <td class="invert">
                                        <div class="quantity">
